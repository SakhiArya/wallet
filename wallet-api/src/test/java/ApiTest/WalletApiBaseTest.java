...
public class WalletApiBaseTest {
    ...
    public void setUp() throws Exception {
        ...
        MvcResult mvcResultForRegisteration = getMvcResult(registerationUri,
            inputJsonForRegisteration);
        ...
        WalletApiResponse<LoginOutput> loginApiResponse = mapFromJson(content,
            new TypeReference<WalletApiResponse<LoginOutput>>() {
            });
        ...
        loginApiResponse = mapFromJson(content,
            new TypeReference<WalletApiResponse<LoginOutput>>() {
            });
    ...
    protected SubmitOtpInput getSubmitRequestForValidatingOTP(String otp, String token, String
        ...
        SubmitOtpInput submitOtpInput = SubmitOtpInput.builder().mobileNumber(mobileNumber).otp(otp)
            .token(token).build();
